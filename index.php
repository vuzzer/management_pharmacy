  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        ...
        <hr class="divider">
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Culpa expedita nobis eligendi nostrum ipsa, debitis ipsum quidem velit impedit id temporibus dolores incidunt mollitia ut vero fugit odio autem necessitatibus.</p>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus dolorem optio itaque consequatur facilis quaerat, at earum eveniet error incidunt modi nobis aspernatur vel! Pariatur quisquam nisi facilis molestias possimus.</p>
      </div>
    ...
    <footer class="bg-faded text-center py-5">
      <div class="container">
        <p class="m-0">Created by &copy; Kouassi Parfait</p>
      </div>
    </footer>
